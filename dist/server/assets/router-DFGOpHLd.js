...
import { Globe, X, Menu, Shield, Zap, Wifi, MapPin, BookOpen, Lock, Server, Gauge, Eye, ChevronUp, ChevronDown, AlertTriangle, ShieldAlert, ShieldCheck, CheckCircle, RefreshCw, Info, Clock, Play, RotateCcw, Download, Upload, Monitor, Check, Copy, Smartphone, Tablet } from "lucide-react";
import { useState, useRef, useMemo, useEffect } from "react";
const AD_ROTATION_MS = 3e5;
...
const hasAdContent = (container, injected) => Array.from(container.children).some((child) => child !== injected && child.textContent?.trim().length);
function TopBannerAd() {
  ...
  const configs = useMemo(
    () => [
      { id: "network-banner", builder: buildNetworkBannerAd, waitForContent: hasAdContent },
      {
        ...
        waitForContent: (container, injected) => Array.from(container.querySelectorAll(".adsbygoogle")).some(
  ...
  return /* @__PURE__ */ jsxs("div", { className: `ad-slot ad-banner ad-fade ${visible ? "ad-visible" : "ad-hidden"}`, children: [
    /* @__PURE__ */ jsx("button", { className: "ad-close-button", type: "button", "aria-label": "Close ad", onClick: closeAd, children: "✕" }),
    /* @__PURE__ */ jsx("div", { className: "ad-content-wrapper", ref: containerRef, children: loading && !visible ? /* @__PURE__ */ jsx("div", { className: "ad-skeleton", children: /* @__PURE__ */ jsx("div", { className: "shimmer" }) }) : null })
  ] });
}
function PwaInstallButton() {
  const [promptEvent, setPromptEvent] = useState(null);
  const [visible, setVisible] = useState(false);
  const [message, setMessage] = useState("Install the app for faster access");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "install-app-banner glass-card p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-white", children: "Install NetWho" }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-[#8b9ec7] mt-1", children: message })
    ] }),
...
function RootLayout() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen bg-[#070b14] cyber-grid overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:hidden bg-[#0a1020] border-b border-[rgba(0,212,255,0.12)]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 px-4 py-3", children: [
          /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-7 h-7 rounded-lg bg-gradient-to-br from-[#00d4ff] to-[#0066ff] flex items-center justify-center shadow-lg shadow-blue-500/20", children: /* @__PURE__ */ jsx(Globe, { className: "w-4 h-4 text-white" }) }),
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("nav", { className: "flex flex-wrap gap-2 px-4 pt-2", children: toolLinks.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxs(
              Link,
              {
                to,
                ...
                children: [
                  /* @__PURE__ */ jsx(Icon, { className: "w-4 h-4 text-[#00d4ff]" }),
                  label
                ]
              },
              to
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden px-4 py-4 lg:px-6 lg:py-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsx(TopBannerAd, {}),
          /* @__PURE__ */ jsx("div", { className: "flex flex-col items-end gap-3", children: /* @__PURE__ */ jsx(PwaInstallButton, {}) })
        ] }),
        /* @__PURE__ */ jsx("main", { className: "flex-1 overflow-auto mt-4", children: /* @__PURE__ */ jsx(Outlet, {}) })
      ] })
    ] })
  ] });
}
...
function InfoRow({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between py-3 border-b border-[rgba(255,255,255,0.05)] last:border-0 group gap-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-[#8b9ec7] min-w-0 sm:min-w-[130px]", children: [
      Icon && /* @__PURE__ */ jsx(Icon, { className: "w-3.5 h-3.5 opacity-70" }),
      /* @__PURE__ */ jsx("span", { children: label })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-1 justify-end min-w-0", children: [
      badge,
      /* @__PURE__ */ jsx(
        "span",
        {
